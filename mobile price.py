...
# Replace 'mobile_data.csv' with your actual dataset file
data = pd.read_csv("C:\\Users\\USER\\Documents\\ML\\mobile_prices.csv")
...
print('Predicted Price for new sample:', predictions)

# Optional: Visualize feature importances if using a tree-based model
if hasattr(model.named_steps['regressor'], 'feature_importances_'):
    importances = model.named_steps['regressor'].feature_importances_
    feature_names = numerical_cols + list(model.named_steps['preprocessor'].transformers_[1][1]['onehot'].get_feature_names(categorical_cols))
